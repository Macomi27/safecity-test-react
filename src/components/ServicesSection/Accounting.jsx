...
const Accounting = () => {
  return (
    ...
    <p className="service-description">
      Gain a competitive edge with accounting services. Our team of consultants provides in-depth analyses of market trends, economic indicators, and industry benchmarks.
